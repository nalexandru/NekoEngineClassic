...
static inline struct CVar *_findCVar(const char *name, enum CVarType type);
static inline struct CVar *_newCVar(const char *name, enum CVarType type);
...
struct CVar *
_findCVar(const char *name, enum CVarType type)
{
	uint64_t hash = 0;
...
struct CVar *
_newCVar(const char *name, enum CVarType type)
{
	uint64_t hash = 0;
	struct CVar *cv = _cvars;

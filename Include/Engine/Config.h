...
struct CVar *E_GetCVarStr(const char *name, const char *def);
struct CVar *E_GetCVarI32(const char *name, int32_t def);
struct CVar *E_GetCVarU32(const char *name, uint32_t def);
struct CVar *E_GetCVarU64(const char *name, uint64_t def);
struct CVar *E_GetCVarFlt(const char *name, float def);
struct CVar *E_GetCVarBln(const char *name, bool def);
